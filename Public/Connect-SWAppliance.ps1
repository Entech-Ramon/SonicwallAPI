function Connect-SWAppliance {
    ...
    process {
        ...
        Try {
            ...
            Invoke-RestMethod -SkipCertificateCheck:$Script:IgnoreCert -Uri "$($SWBaseUrl)$($Resource)" -Headers $Headers -Method $Method | Out-Null
            # Set an environmental variable with the base URL of the connection to reuse in the rest of the PSSonicWall functions
            $Script:SWConnection = $SWBaseUrl
        }
        Catch {
            Throw $_
        }
